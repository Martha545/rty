...
<div class="container-fluid">
    <form action="" id="service-form">
        ...
        <div class="form-group">
            ...
            <textarea rows="3" name="description" id="description" class="form-control form-control-border summernote" placeholder="Write the service description here." required><?php echo isset($description) ? $description : '' ?></textarea>
        </div>
        <div class="form-group">
